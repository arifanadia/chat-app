                    ...
                    <div key={contact._id} className={`pl-10 py-2 transition-all duration-300 cursor-pointer
                     ${selectedChatData && selectedChatData._id === contact._id ? "bg-[#8417ff] hover:bg-[8417ff]" : "hover:bg-[#f1f1f111]"}`}
                        ...
                        <div className="flex items-center justify-start gap-5 text-neutral-300">
                                            ...
                                            contact.image ?
                                                ...
                                                <div className={`
                                                  ${selectedChatData && selectedChatData._id === contact._id ?
                                                     "bg-[#ffffff22] border-white/70" : getColor(contact.color)}
                                                uppercase size-10 border-[1px] text-xl flex items-center justify-center rounded-full  `}>
                                                    {
                                                        contact.firstName ?
                            ...
                            {
                                isChannel && <div className="bg-[#ffffff22] flex items-center justify-center rounded-full">
                                    #
                                </div>
                            }
                            {
